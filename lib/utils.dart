...
Color get secondaryBackgroundColor => Store.isLightMode.value ? Color(0xffFFFFFF) : Color(0xff282A2E);
Color get tabBtnBackgroundColor => Store.isLightMode.value ? Color(0xffEEEEEE) : gray400;
Color get secondaryTextColor => Store.isLightMode.value ? Color(0xFF3B3B3B) : Color(0xFFEEEEEE);
...
const Color gray400 = Color(0xFF3F424A);